...
echo isset($_SESSION['user_id']) ? '' : ' data-toggle="modal" data-target="#loginModal"';      
    ?> href="#"> Login </a></li>
<li><a href="http://localhost/Mongo/index.php?show=modal" ><span id="cart" class="btn btn-success"> <span class="glyphicon glyphicon-shopping-cart"></span><span class="badge" id="shopcart">
...
<h2 style="text-align:center; font-size: 90px;">Your Food Choices</h2>
  <div class="container-fluid">
  <ul class="nav navbar-nav">
  <li style="text-align:right; width:250px; margin: 0 auto;"><a>
  <?php
$query = $collection_foods->find([],['projection'=>['companyName'=>2, '_id'=>0]]);
